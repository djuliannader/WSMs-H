...
c     $ FCT, icorr, EPSC
      COMMON / NINPUT3 / nrhoN, nrhoD, nzN, nzD, icorr
      COMMON / XINPUT2 / xB, EPSin, EPSid,  FCT, EPSC
      COMMON / PARHAM /  ep1,ep2, efm, im,incharge,k
...
c
      ...
      read(5,*)incharge, ep1, ep2, im, efm  
      read(5,*)
      read(5,*)k
      read(5,*)
...
c     .. Parameters for the integration routine D01FCF ...
      ...
      PARAMETER       (NDIM=2,MAXPTS=100000000,LENWRK=5000000)
c     .. LOCAL ARRAYS ...
...
c     .. EXTERNAL FUNCTIONS ...
      EXTERNAL          D01FCF, EVARN, EVARD, EORT1, EORT2
c     .. EXECUTABLE STATEMENTS ...
c
      icall = icall + 1
      FVAL  = 0.0D0
...
cc     In this section we calculate the quadrupole moment:
          iqflag = 1   ! flag to calculate Quadrupole Moment 
          MINPTS = 0
          IFAIL  = 1
          FINVQ  = 0.0D0
c
